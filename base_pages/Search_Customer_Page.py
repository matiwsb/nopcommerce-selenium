...
class Search_Customer_Page:
    ...
    def enter_customer_companyname(self, cmpname):
        self.driver.find_element(By.ID, self.text_cmpname_id).clear()
        self.driver.find_element(By.ID, self.text_cmpname_id).send_keys(cmpname)
    ...
    def get_result_table_cols(self):
    ...
    def search_customer_by_company(self, company_name):
        ...
        for r in range(1, self.get_result_table_rows() + 1):
            company_name = self.driver.find_element(By.XPATH,
